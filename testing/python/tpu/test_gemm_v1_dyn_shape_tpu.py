...
print("func_source:")
print(matmul_dyn_shape.func_source)
print("signature:")
print(matmul_dyn_shape.signature)

print("TIR:")
print(matmul_dyn_shape.get_tir().script())

# kernel = matmul_dyn_shape.compile()
kernel = matmul_dyn_shape()
print("CUDA Source:")
